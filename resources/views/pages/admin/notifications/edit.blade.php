                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <form class="form-vertical" enctype="multipart/form-data" role="form" method="post"
                                  action="{{ route('admin.notifications.edit', ['id' => $notification->id]) }}">

                                <div class="form-group{{ $errors->has('title') ? ' has-error' : ''}}">
                                    <input type="text" name="title" class="form-control" id="title"
                                           value="{{Request::old('title') ?: $notification->title}}" placeholder="Title"/>
                                    @if ($errors->has('title'))
                                ...
                                <textarea rows="20" name="notification" class="form-control tinymce" id="notification"
                                    ...
                                    {{Request::old('notification') ?: $notification->notification }}
                                </textarea>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-default aligncenter">Update</button>
                                </div>
