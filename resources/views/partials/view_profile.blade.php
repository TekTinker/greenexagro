        ...
        <div class="table-responsive">
            <table class="table" style="border: hidden">
                ...
                @if( $user->role == 'customer')
                    ...
                    <tr>
                        <td style="text-align: right; font-size: large; vertical-align: middle">Crops :</td>
                        <td style="text-align: left; font-size: larger; vertical-align: middle">
                            @foreach($crops as $crop)
                                {{ $crop->area . " Acre  :- " .   $crop->crop_name}}<br>
                            @endforeach
                        </td>
                    </tr>
